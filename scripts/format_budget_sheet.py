#!/usr/bin/env python3
"""Format the existing Budget Tracker Google Sheet (add validation, formatting, Summary tab)."""
import os
...
expenses_sid = meta["sheets"][0]["properties"]["sheetId"]

s_id = expenses_sid  # Expenses tab
...
summary_sid = resp["replies"][0]["addSheet"]["properties"]["sheetId"]
...
summary_data = [
    ...
    ["", "", "", ""],
    ["Total Expenses (excl. Income)", "=SUMIF(Expenses!B:B,\"<>\"&$B$2,Expenses!E:E)-SUMIFS(Expenses!E:E,Expenses!B:B,\"<>\",Expenses!C:C,\"Income\")", "", ""],
...
requests_fmt = [
    {
        "repeatCell": {
            "range": {"sheetId": summary_sid, "startRowIndex": 0, "endRowIndex": 1, "startColumnIndex": 0, "endColumnIndex": 4},
            "cell": {
                "userEnteredFormat": {
    ...
    {
        "repeatCell": {
            "range": {"sheetId": summary_sid, "startRowIndex": 8, "endRowIndex": 9, "startColumnIndex": 0, "endColumnIndex": 4},
            "cell": {
                "userEnteredFormat": {
    ...
    {
        "repeatCell": {
            "range": {"sheetId": summary_sid, "startRowIndex": 21, "endRowIndex": 22, "startColumnIndex": 0, "endColumnIndex": 4},
            "cell": {
                "userEnteredFormat": {
                    "textFormat": {"bold": True, "foregroundColor": {"red": 1, "green": 1, "blue": 1}},
                    "backgroundColor": {"red": 0.18, "green": 0.35, "blue": 0.65},
    ...
    {
        "repeatCell": {
            "range": {"sheetId": summary_sid, "startRowIndex": 4, "endRowIndex": 24, "startColumnIndex": 1, "endColumnIndex": 4},
            "cell": {
    ...
    {"autoResizeDimensions": {
        "dimensions": {"sheetId": summary_sid, "dimension": "COLUMNS", "startIndex": 0, "endIndex": 4}
    }},
]
...
print(f"All done! Open your Budget Tracker:\n{sheet_url}")
